...
export const OrderPage = () => {
    ...
    if ( !isLoading && MyBookings ) {
        ...
        <div className='favourite_herodection' style={{
            ...
            <div className='favourite_herodection-txt' >My Orders</div>
        </div>
        ...
        <div className='checkout-main' style={{
            ...
            { MyBookings.length > 0 ? MyBookings.map( (book,index) => {
                return  <div className='checkout-main-middle' style={{
                    ...
                    marginTop:"40px"
                            ...
                            <div className='checkout-main-middle-title' >Ticket</div>
                            ...
                            <div className='checkout-det' >
                                ...
                                <img src={ book.site.site_images[0].url } className='checkout-det-img' alt="fingtt" />

                                <div className='checkout-det-right' >
                                    <div className='checkout-det-right-top' >{book.site.site_name}</div>

                                    <div className='checkout-det-right-split' >
                                        <GoLocation className='checkout-det-right-split-ic' />
                                        {book.site.site_address}
                                    </div>
                                    ...
                                    <div className='checkout-det-right-split' >
                                        ...
                                        {book.number_of_passengers} Passengers
                                    </div>
                            ...
                            <div className='checkoutSlit' >
                                ...
                                <div className='checkoutSlit-right' > <span className='checkoutSlit-right-span' >({`${book.number_of_passengers} Passengers`})</span>₦{new Intl.NumberFormat().format(book.total)}</div>
            ...
            <div className='favourite-text' >No Order</div>
