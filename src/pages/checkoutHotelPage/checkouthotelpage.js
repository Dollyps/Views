...
export const CheckoutHotelPage = () => {
    ...
    const HandleCheckoutSubmit = () => {
        ...
        if ( CheckOutDetails.number_of_days === '' || CheckOutDetails.number_of_days === '0' ) {
            addNotification({
                title: 'Warning',
        ...
        axios.post('/auth/create_se',dataToSend)
            .then( (response) => {
                ...
                addNotification({
                    ...
                    message: 'You have successfully booked this Hotel',
                    theme: 'darkblue',
                    native: true // when using native, your OS will handle theming.
                });
                console.log(response.data)
                navigate("/my_hotel_orders")
            } )
            .catch( (err) => {
                setBtnisLoading(false)
                if ( err.response ) {
    ...
    if ( !isLoading && SiteDetail ) {
        ...
        <div className='favourite_herodection' >
                <div className='favourite_herodection-txt' >Book Reservation</div>
            ...
            <div className='checkout-main-middle' >
                ...
                <div className='checkout-main-middle' >
                    ...
                    <div className='main-div-form' >
                        <label className='main-div-form-label' >Numbers of Night</label>
                        <div className='main-div-split' >
                        <input className='main-div-form-input' placeholder='Number of nights' min={0} type={"number"} value={CheckOutDetails.number_of_passengers} onChange={ (e) => {
                            setCheckOutDetails({
                                ...CheckOutDetails,
                ...
                <div className='checkout-main-middle' >
                    ...
                    <div className='checkout-det' >
                        ...
                        <img src={ SiteDetail.hotel_images[0].url } className='checkout-det-img' alt="fingtt" />

                        <div className='checkout-det-right' >
                            <div className='checkout-det-right-top' >{SiteDetail.hotel_name}</div>

                            <div className='checkout-det-right-split' >
                                <GoLocation className='checkout-det-right-split-ic' />
                                {SiteDetail.hotel_address}
                            </div>
                            ...
                            { CheckOutDetails.number_of_days !== '' ? 
                                <div className='checkout-det-right-split' >
                                    <BsBookmark className='checkout-det-right-split-ic' />
                                    {CheckOutDetails.number_of_days} Nights
                                </div>
                            : "" }
                    ...
                    <div className='checkoutSlit' >
                        ...
                        <div className='checkoutSlit-right' > <span className='checkoutSlit-right-span' >({`${CheckOutDetails.number_of_days} Nights`})</span>₦{new Intl.NumberFormat().format(CheckOutDetails.number_of_days * SiteDetail.hotel_price)}</div>
                    ...
                    <div className='checkoutSlit' style={{
                        ...
                        <div className='checkoutSlit-right' >₦{new Intl.NumberFormat().format(CheckOutDetails.number_of_days * SiteDetail.hotel_price)}</div>
